...
%% function geom = geom_2dtri_hexagon(N, K, alpha {, bc})
%
% generates the geometry structure for a triangular lattice, in a
% hexagonal domain, with atomistic region in the centre
%
% Input
...
function test_geom_2dtri_hexagon()
close all
N = 10;
K = 5;
